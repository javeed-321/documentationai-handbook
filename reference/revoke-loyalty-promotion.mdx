...
<CodeGroup show-lines="true" tabs={["REVOKE_ENROLL","REVOKE_OPTIN"]}>
  ```bash REVOKE_ENROLL
...
<CodeGroup default-tab="2" show-lines="true" tabs={["REVOKE_ENROLL success","REVOKE_ENROLL with opt-in","Per-customer failure (no active enrollment)"]}>
  ```json "REVOKE_ENROLL success"
  {
      "data": {
          "requestId": "revoke-enroll-20260512-001",
          "action": "REVOKE_ENROLL",
  ...
  ```text "Per-customer failure (no active enrollment)"
  {
      "data": {
