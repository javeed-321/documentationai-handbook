...
<CodeGroup default-tab="0" show-lines="true" tabs={["cURL"]}>
  ```text wrap="true" cURL
  // Add your code herecurl -X GET "https://{host}/v3/members/388757266/promotions/1133608813?memberEnrollmentStatus=AVAILABLE_TO_REDEEM" \
...
<CodeGroup default-tab="0" show-lines="true" tabs={["JSON"]}>
  ```json JSON
  {
      "memberId": 388757266,
      "promotions": [
