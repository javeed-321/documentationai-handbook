...
<CodeGroup default-tab="2" show-lines="true" tabs={["REVOKE_ENROLL","REVOKE_OPTIN"]}>
  ```bash REVOKE_ENROLL
...
<CodeGroup show-lines="true" tabs={["REVOKE_ENROLL success","REVOKE_ENROLL with opt-in","Per-customer failure (no active enrollment)"]}>
