...
<CodeGroup show-lines="true" tabs={["ENROL","OPT_IN"]}>
  ```bash ENROL
...
<CodeGroup show-lines="true" tabs={["Enroll reference structure","Opt -in reference structure"]}>
  ```text "Enroll reference structure"
  {{promotions_enrol}}
     └─ {{EnrollmentRequest}}
        ├─ {{requestId}} (string)
        ├─ {{action}} (string)
  ...
  ```text "Opt -in reference structure"
  {{promotions_enrol}}
     └─ {{OptInRequest}}
        ├─ {{requestId}} (string)
        ├─ {{action}} (string)
