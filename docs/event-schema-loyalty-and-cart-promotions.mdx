...
<CodeGroup tabs={["Webhook payload - Transaction events","Webhook payload - Generic events","Webhook payload - Target completed event","Non webhook payload"]}>

```json "Webhook payload - Transaction events"
{
...
```json "Webhook payload - Generic events"
{
...
```json "Webhook payload - Target completed event"
{
