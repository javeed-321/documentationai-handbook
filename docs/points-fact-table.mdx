...
| dim_awarded_date_id | bigint | Date when points were awarded to the customer. | [date](/dimensions-tables#date) | Yes; Dimension Name: Awarded date > Date |
| dim_awarded_expiry_date_id | bigint | Date when the awarded points are set to expire. | [date](/dimensions-tables#date) | Yes; Dimension Name: Awarded Expiry Date > Date |
...
| dim_awarded_zone_till_id | bigint | Identifier assigned to the point-of-sale (POS) terminal within a store, where the points were awarded. It distinguishes one checkout location from another within the same store. | [zone_till](/dimensions-tables#zone-till) | Yes; Dimension Name: Awarded Zone Till > Till Id |
| dim_category_id | bigint | Identifier which indicates the type of points awarded or deducted. The points categories can be - regular points, promised points, alternate currencies, trackers, and external trigger based points. | [points_category](/dimensions-tables#points-category) | Yes; Dimension Name: Category > Category Id |
| dim_deduction_type_id | bigint | Identifier indicating the type of deduction. Possible values are - cancelled, expired, migrated, redeemed, returned, etc. | [deduction_type](/dimensions-tables#deduction-type) | Yes; Dimension Name: Deduction Type > Id |
| dim_event_date_id | bigint | Date when the points were allocated/ deducted. | [date](/dimensions-tables#date) | Yes; Dimension Name: Date > Date |
...
| dim_event_program_id | bigint | Identifier of the loyalty program associated with the points event. | [program](/dimensions-tables#program) | Yes; Dimension Name: Event Program > Program Id |
| dim_event_time_id | bigint | Time when the points were allocated/ deducted. | [time](/dimensions-tables#time) | Yes; Dimension Name: Time > Time Id |
| dim_event_user_id | bigint | Identifier of the user, set internally by Capillary. | [users](/dimensions-tables#users-users) | Yes; Dimension Name: User > User Id |
| dim_event_zone_till_id | bigint | Identifier assigned to the point-of-sale (POS) terminal within a store, where the points event occurred. It distinguishes one checkout location from another within the same store. | [zone_till](/dimensions-tables#zone-till) | Yes; Dimension Name: Store Hierarchy > Till Id |
| dim_expiry_date_id | bigint | Date when the allocated points are set to expire. | [date](/dimensions-tables#date) | _ |
| dim_expiry_time_id | bigint | Time when the allocated points are set to expire. | [time](/dimensions-tables#time) | _ |
...
| dim_points*awarded* | bigint | Identifier for the type of points that are awarded. Possible values are - bill promotion, line item, line item promotion, and customer promotion. This is the primary key of the table. | points_awarded_type [Link](/dimensions-tables#points-awarded-type) | Yes; Dimension Name: Points Awarded Type > Id |
| dim_points_event_type_id | bigint | Identifier for the type of event, indicating whether points were awarded or deducted. This is the primary key of the table. | [points_event_type](/dimensions-tables#points-events-type) | Yes; Dimension Name: Points Event Type > Id |
| dim_points_promotion_id | bigint | Identifier for the promotion against which points were allocated, redeemed, or expired. | [points_promotions](/dimensions-tables#points-promotion) | Yes; Dimension Name: Points Promotion > Id |
...
| dim_old_category_id | bigint | Refers to point_category_id in individual points tables, indicating the category of points, such as redeemable, tracker, or delayed accrual. | [points_category](/dimensions-tables#points-category) | _ |
...
| dim_event_date_id | bigint | Date when the points were redeemed. | [date](/dimensions-tables#date) | Yes; Dimension Name: Date > Date |
| dim_event_user_id | bigint | Identifier of the user, set internally by Capillary. | [users](/dimensions-tables#users-users) | Yes; Dimension Name: User > User Id |
| dim_event_zone_till_id | bigint | Identifier assigned to the point-of-sale (POS) terminal within a store, where the points were redeemed. It distinguishes one checkout location from another within the same store. | [zone_till](/dimensions-tables#zone-till) | Yes Dimension: Concept_Hierarchy > Till_Id |
| dim_latest_updated_date_id | bigint | Date when the data corresponding to this event/ row is changed in the source table. | [date](/dimensions-tables#date) | Yes; Dimension Name: Latest Updated Date > Date |
| dim_latest_updated_time_id | bigint | Time when the data corresponding to this event/ row is changed in the source table. | [time](/dimensions-tables#time) | Yes; Dimension Name: Latest Updated Time > Time Id |
| dim_redemption_program_id | bigint | Identifier of the loyalty program associated with the points redemption. | [program](/dimensions-tables#program) | Yes; Dimension Name: Program > Program Id |
| dim_redemption_type_id | string | Identifier for the points redemption type. Possible values are redemption, reversal, group_redemption, and reversal_on_return. | [redemption type](/dimensions-tables#redemption-type) | Yes; Dimension Name: Redemption Type > Id |
...
| dim_communication channel_id | bigint | Indicates the channel used for communicating with the customer. Possible values are - SMS, email, voicemail, Wechat, Facebook, Viber, etc. | communication_channel [Link](/dimensions-tables#communication-channel) | Yes; Dimension Name : Communication Channel > Id |
| dim_event_date_id | bigint | Date when the points expiry reminder is sent. | [date](/dimensions-tables#date) | Yes; Dimension Name : Date > Date |
| dim_event_time_id | bigint | Time when the points expiry reminder is sent. | [time](/dimensions-tables#time) | Yes; Dimension Name : Time > Time Id |
| dim_event_user_id | bigint | Identifier for the customer who has performed the redemption or reversal, part of the points_redemption_summary fact. | [users](/dimensions-tables#users-users) | Yes; Dimension Name : User > User Id |
| dim_expiry_date_id | bigint | Date when the allocated points are set to expire. | [date](/dimensions-tables#date) | Yes; Dimension Name : Expiry Date > Date |
| dim_expiry_time_id | bigint | Time when the allocated points are set to expire. | [time](/dimensions-tables#time) | Yes; Dimension Name : Expiry Time > Time Id |
| dim_latest_updated_date_id | bigint | Date when the data corresponding to this event/row is changed in the source table. | [date](/dimensions-tables#date) | Yes; Dimension Name : Latest Updated Date > Date |
| dim_latest_updated_time_id | bigint | Time when the data corresponding to this event/row is changed in the source table. | [time](/dimensions-tables#time) | Yes; Dimension Name : Latest Updated Time > Time Id |
