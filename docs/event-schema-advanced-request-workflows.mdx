...
<CodeGroup show-lines="true" tabs={["Pending","Failed","Approved","Rejected"]}>
  ```json Pending
  {
...
<CodeGroup show-lines="true" tabs={["Pending","Failed","Approved"]}>
  ```json Pending
  {
    "eventName": "requestWorkflowEvent",
...
<CodeGroup show-lines="true" tabs={["Pending ","Approved"]}>
  ```json "Pending "
  {
    "eventName": "requestWorkflowEvent",
...
<CodeGroup show-lines="true" tabs={["Pending ","Failed"]}>
  ```json "Pending "
  {
    "eventName": "requestWorkflowEvent",
