...
<CodeGroup tabs={["Webhook payload","Non webhook payload"]}>
...
<CodeGroup tabs={["Non webhook payload"]}>
```json "Non webhook payload"
{
...
<CodeGroup tabs={["Points unlock API", "Delayed accrual job", "Via Transaction Add"]}>
...
<CodeGroup tabs={["Via thrift (API-Immediate)", "via Points Expiry Batch (Scheduled job)"]}>
