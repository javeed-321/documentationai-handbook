...
<CodeGroup show-lines="true" tabs={["Webhook payload","Non webhook payload"]}>
...
<CodeGroup show-lines="true" tabs={["Non webhook payload"]}>
  ```json "Non webhook payload"
  {
...
<CodeGroup show-lines="true" tabs={["Fixed window","Cyclic Window"]}>
  ```json "Fixed window"
  {
...
<CodeGroup show-lines="true" tabs={["via transaction","Non webhook payload","Good will points"]}>
...
<CodeGroup show-lines="true" tabs={["Webhook payload"]}>
  ```json "Webhook payload"
  {
     "eventName":"pointsRedeemed",
...
| eventId                     | String           | Unique identifier for the event.                                                                  |
| eventLogId                  | Integer          | Unique ID that is generated when the event is triggered.                                          |
| eventType                   | String           | It combines the orgid and event name (e.g., "1000006\_promisedToCurrentPointsConversion").        |
...
| eventDateTime               | String           | The exact moment the activity occurred. This field is being replaced by eventDateTimeInMillis.    |
| eventDateTimeInMillis       | String           | The exact moment the activity occurred in the Unix epoch timestamp.                               |
...
| promotionStartDate          | String           | Promotion start date. This field is being replaced by promotionStartDateInMillis.                 |
| promotionStartDateInMillis  | String           | Promotion start date in in the Unix epoch timestamp.                                              |
| promotionEndDate            | String           | Promotion end date. This field is being replaced by promotionEndDateInMillis.                     |
| promotionEndDateInMillis    | String           | Promotion end date in the Unix epoch timestamp.                                                   |
| loyaltyEventId              | String           | Unique identifier for the loyalty event.                                                          |
...
<CodeGroup show-lines="true" tabs={["Points unlock API","Delayed accrual job","Via Transaction Add"]}>
...
<CodeGroup show-lines="true" tabs={["Via thrift (API-Immediate)","via Points Expiry Batch (Scheduled job)"]}>
  ...
  ```json "via Points Expiry Batch (Scheduled job)"
  {
      "eventName": "pointsExpiryChange",
      "eventSearchKey": "data.customerIdentifiers.customerId",
      "data":
...
<CodeGroup show-lines="true" tabs={["Webhook payload","Non webhook payload"]}>
  ...
  data: {
      ...
      entityInformation: {
          entityId: 386959475,                              // added comma
          entityType: USER
      },
      loyaltyProgramDetails: {
          id: 2645,                                         // added comma
          isDefault: true,                                  // added comma
          name: Test_OrgDefaultProgram,                     // added comma
          pointsToCurrencyRatio: 1,                         // added comma
          tiers: [
              {
                  tierName: Default_tier,                   // added comma
                  tierNumber: 1
              },
              {
                  tierName: Silver_tier,                    // added comma
                  tierNumber: 2
              },
              {
                  tierName: Gold_tier,                      // added comma
                  tierNumber: 2
              }
          ]
      },
      loyaltyProgramId: 2645,
      alternateCurrencies: [                                // removed stray "
          {
              ...
              currentEventPromotionAlternateCurrenciesReturnedDetails: [  // changed { to [
                  {
              ...
              regularAlternateCurrenciesReversed: 10,       // added comma
          ...
          },
          {
              ...
              promotionalAlternateCurrenciesReversed: [
                  {
                      promotionIdentifier: 528d181-7e91-4abe-86cd-598cee9b8ccf,
                      promotionAlternateCurrencies: 100,    // added missing colon
                      promotionType: BILL
                  },
                  {
                      promotionIdentifier: a6cb5a7e-3d84-4f1f-87c6-5f26006f6392,
      ...
      eventId: 1de73162-daf8-4c39-bc63-0af20bb4371e,       // added comma
      eventName: issuedalternateCurrenciesReversed,         // added comma
      loyaltyEventId: 1c1716568b10135aa4e59fda77935ea2014b3bfc, // added comma
      orgId: 51182,                                         // added comma
