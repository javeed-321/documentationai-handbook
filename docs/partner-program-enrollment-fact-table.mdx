...
| dim_external_partner_program_id                    | bigint    | The Unique Identifier for an external partner program that is linked to the enrollment.                                                           | [partner_programs](https://docs.capillarytech.com/docs/dimension-tables#partner-programs-partner_programs)     |
...
| dim_partner_program_id                              | bigint    | The Unique Identifier for the partner program in which the customer is enrolled.                                                                  | [partner_programs](https://docs.capillarytech.com/docs/dimension-tables#partner-programs-partner_programs)     |
