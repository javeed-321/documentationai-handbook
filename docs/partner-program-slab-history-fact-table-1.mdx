...
| dim\_event\_date\_id                          | bigint    | Indicates the date when the slab change occurred.                                                                                                      | [date](/dimensions-tables#date)       |
...
| is\_active                                    | boolean   | Indicates whether the program is currently active.                                                                                                     | [program](/dimensions-tables#program) |
