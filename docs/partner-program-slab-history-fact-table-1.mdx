...
| dim_event_date_id                          | bigint    | Indicates the date when the slab change occurred.                                                                                                      | [date](/dimensions-tables#date)       |
...
| is_active                                    | boolean   | Indicates whether the program is currently active.                                                                                                     | [program](/dimensions-tables#program) |
| is_linked                                    | boolean   | Indicates whether the program is linked.                                                                                                               | -                                                                       |
| year                                          | integer   | Indicates the year of the slab history record.                                                                                                         | [date](/docs/dimension-tables#date)                                     |
