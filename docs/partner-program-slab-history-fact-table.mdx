...
**Partner Program Slab History Fact - Entity Relationship Diagram (ERD)**
...
| dim_event_date_id                          | bigint    | Indicates the the date when the slab change occurred.                                                                                       | [date](/dimensions-tables#date)                                                                  |
| dim_event_program_id                       | integer   | The Unique identifier of the program associated with the customer's slab change.                                                            | [program](/dimensions-tables#program)                                                            |
...
| dim_event_zone_till_id                    | bigint    | The till ID where the slab change transaction occurred.                                                                                     | [zone_tills](/dimensions-tables#zone-till)                                                      |
...
| dim_latest_updated_date_id                | bigint    | Indicates the date when the data corresponding to this row was last updated in the source table.                                            | [date](/dimensions-tables#date)                                                                  |
| dim_latest_updated_time_id                | bigint    | Indicates the time when the data corresponding to this row was last updated in the source table.                                            | [time](/dimensions-tables#/time)                                                                 |
| dim_partner_program_id                     | integer   | The Unique Identifier for the partner program associated with the slab history.                                                             | [partner_programs](/dimensions-tables#partner-programs-partner_programs)                     |
...
| year                                          | integer   | Indicates the year in which the slab change occurred.                                                                                       | [date](/docs/dimension-tables#date)                                                                                                |
