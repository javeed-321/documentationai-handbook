...
| dim_partner_program_id                     | integer   | The Unique Identifier for the partner program associated with the slab history.                                                             | [partner_programs](https://docs.capillarytech.com/docs/dimension-tables#partner-programs-partner_programs)                     |
