...
<Image src="https://files.readme.io/d643219-Customer.jpg" width="150%" height="1080" alt="" />
...
<Image src="https://files.readme.io/afc70c0-Customer_source.png" width="NaN" height="NaN" alt="" style="width: NaNpx; height: auto; cursor: pointer;" />
...
<Image src="https://files.readme.io/e70b5ed-H3fEa_kClhg1C9buCL58znQ3t4tvnHcb2g.png" width="1920" height="1080" alt="" />
...
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Block communications                      | When block communication is active for a customer's status label, all outbound messages are suppressed. This includes transactional messages, promotional messages, OTPs, goodwill notifications, and subscription notifications. There is no exception by message type. Block communication operates independently of a customer's subscription preferences. A customer can be opted in to all channels and still have all communications suppressed if their status label has block communication enabled. For the list of APIs on which communication will be blocked, see [here](https://docs.capillarytech.com/docs/customer_entity#request-apis). |
...
<Image src="https://files.readme.io/ccef7e2-lb5ZVDRSQL_JkADaNE0G9ONiVhqtT0GynQ.png" width="1920" height="1080" alt="" />
...
<Image src="https://files.readme.io/a198377-Delete_customer_status.png" width="35%" height="1080" alt="" />
